...
public:
    ...
    bool isSquareOccupiedBy(int8_t rank, int8_t file, const GameState& state, Player player) const;
    bool isSquareUnderAttack(int8_t rank, int8_t file, const GameState& state) const;
    bool isSquareUnderAttackByBishopOrQueen(int8_t rank, int8_t file, const GameState& state) const;
    bool isSquareUnderAttackByKing(int8_t rank, int8_t file, const GameState& state) const;
    bool isSquareUnderAttackByKnight(int8_t rank, int8_t file, const GameState& state) const;
    bool isSquareUnderAttackByPawn(int8_t rank, int8_t file, const GameState& state) const;
    bool isSquareUnderAttackByRookOrQueen(int8_t rank, int8_t file, const GameState& state) const;
